...
{
    /// <inheritdoc />
    public partial class AddedUserCreatedQuestionModelcs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UserCreatedQuestions",
                columns: table => new
                {
                    ...
                    UserCreatedSubjectId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCreatedQuestions", x => x.Id);
                });
        }
